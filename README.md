...
***
#### PUT
XSREs are created and updated via a PUT request using the following URL format:
...
The following required headers must be present in the PUT request:
...
***
#### DELETE
XSREs are deleted via a DELETE request using the following URL format:
...
The following required headers must be present in the DELETE request:
